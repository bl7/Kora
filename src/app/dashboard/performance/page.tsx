...
export default function PerformancePage() {
  ...
  const sorted = useMemo(() => {
    ...
    return [...reps].sort((a, b) => {
      if (sortKey === "exception_rate") return (a[key] as number) - (b[key] as number);
  ...
  return (
    <div className="space-y-10 pb-12">
      <div className="flex flex-col gap-2">
        <Breadcrumbs items={[{ label: "PERFORMANCE" }]} />
        <h1 className="text-3xl font-black tracking-tight text-zinc-900 dark:text-zinc-100">Performance</h1>
        <p className="text-sm font-medium text-zinc-500">Rep rankings across visits, orders, revenue, and exception rate.</p>
      </div>
              ...
              >
                <div className="flex items-center gap-5">
                  ...
                  <div className="shrink-0 text-right">
                    <p className="text-[18px] font-black text-zinc-900 dark:text-zinc-100">${revenue.toLocaleString()}</p>
