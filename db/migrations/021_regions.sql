...
-- ── Regions ────────────────────────────────────────────────────────────────
-- A region is a named geographic or organisational grouping scoped to a
-- company. Shops are assigned to one optional region. Staff (reps/managers)
-- can have a default region used for routing and filtering.
CREATE TABLE IF NOT EXISTS regions (
  ...
  UNIQUE (company_id, name)                           -- names unique per company
);
